...
```
BV46.info <- read.table("BV46.info", header=T)
BV46.NaturalPonds.genind@pop <- as.factor(BV46.info$region)
coords <- BV46.info[,c(3,2)]
xy.natural <- as.matrix(coords)
xy.natural <- jitter(xy.natural)  ##add random variation. 
BV46.NaturalPonds.genind@other$xy <- NULL
BV46.NaturalPonds.genind@other$xy <- xy.natural
plot(BV46.NaturalPonds.genind@other$xy)

temp <- BV46.NaturalPonds.genind@pop
levels(temp) <- c(3,5)
temp <- as.numeric(as.character(temp))
plot(BV46.NaturalPonds.genind@other$xy, pch=temp, cex=1.5,xlab='x',ylab='y')
legend("topright",leg=c("East", "Middle"),pch=c(3,5))


D <- dist(BV46.NaturalPonds.genind@tab)
gab <- chooseCN(BV46.NaturalPonds.genind$other$xy,ask=FALSE,type=2)


mon1 <- monmonier(BV46.NaturalPonds.genind@other$xy, D, gab)

pairwise.fst(BV46.NaturalPonds.genind)
           1
2 0.02189529

replicate(10, pairwise.fst(BV46.NaturalPonds.genind, pop=sample(pop(BV46.NaturalPonds.genind))))
[1] 0.01552418 0.01740070 0.01376387 0.01546865 0.01730537 0.01373405
 [7] 0.01718451 0.01576277 0.01376357 0.01756106
